...
import net.kuujo.vertigo.deployment.impl.LocalDeploymentManager;
import net.kuujo.vertigo.spi.DeploymentManagerFactory;

/**
 * Local context manager factory implementation.
 *
 * @author <a href="http://github.com/kuujo">Jordan Halterman</a>
 */
public class LocalDeploymentManagerFactory implements DeploymentManagerFactory {

  @Override
  public DeploymentManager createContextManager(Vertx vertx, VertigoOptions options) {
    return new LocalDeploymentManager(vertx);
  }
