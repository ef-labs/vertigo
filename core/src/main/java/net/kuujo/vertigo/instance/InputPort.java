 ...
 *
 * The input port can contain any number of {@link InputConnection}
 ...
 */
@VertxGen
public interface InputPort<T> extends Port<InputPort<T>>, Input<InputPort<T>, T>, Handler<Message<T>> {
}
