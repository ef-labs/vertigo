...
import net.kuujo.vertigo.network.builder.*;
...
public class ConnectionSourceComponentBuilderImpl implements ConnectionSourceComponentBuilder {
  ...
  public ConnectionSourceComponentBuilderImpl(NetworkBuilderImpl network, Collection<ConnectionConfig> connections, ConnectionConfig connection) {
    this.network = network;
    this.component = null;
    this.connections = connections;
    this.connection = connection;
