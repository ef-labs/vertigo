...
import net.kuujo.vertigo.network.builder.ConnectionSourceBuilder;
import net.kuujo.vertigo.network.builder.ConnectionSourceComponentBuilder;
...
public class ConnectionSourceBuilderImpl implements ConnectionSourceBuilder {
  ...
  @Override
  public ConnectionSourceComponentBuilder network() {
    ConnectionConfig connection = network.network.createConnection(new ConnectionConfigImpl());
    connections.add(connection);
    connection.getSource().setIsNetwork(true);
    return new ConnectionSourceComponentBuilderImpl(network, connections, connection);
  }
